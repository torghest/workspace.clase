...
--
-- Servidor: localhost
-- Tiempo de generación: 04-04-2014 a las 09:29:34
...
INSERT INTO `submenu` (`id`, `nombre`, `pagina`, `id_padre`) VALUES
(1, 'SubMenu.2.1', 'SubMenu.2.1', 2),
(2, 'SubMenu.2.2', 'SubMenu.2.2', 2),
(3, 'SubMenu.2.3', 'SubMenu.2.3', 2),
