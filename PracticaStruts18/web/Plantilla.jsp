...
<html>
    <head>
        ...
        <title><bean:write name="datosEquipo" property="nombre"/></title>
    </head>
    <body>
        <div align="center">
                    ...
                    <tr>
                        <td align="center">
                            <div style="border: 2px solid; text-align: center; background-color: #FFFFFF; width:55px; margin: 0px 20px">
                                <img src="Imagenes/<bean:write name="datosEquipo" property="foto_escudo"/>"/>
                            </div>
                        </td>
                        <td align="center">
                            <font size="6" color="#DD55AA">
                            <b><bean:write name="datosEquipo" property="nombre"/></b>
                            </font>
                        </td>
                    </tr>
                </table>
